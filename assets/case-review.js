(function(){
  ...
  function loadSpatialPolish(){if(document.querySelector('script[data-spatial-polish-layer]'))return;const s=document.createElement('script');s.src='./assets/spatial-polish.js';s.dataset.spatialPolishLayer='true';s.onload=promoteImpeccableLayer;document.body.appendChild(s)}
  function loadTelemetry(){const existing=document.querySelector('script[data-telemetry-layer]');if(existing){loadSpatialPolish();return}const s=document.createElement('script');s.src='./assets/telemetry.js';s.dataset.telemetryLayer='true';s.onload=loadSpatialPolish;document.body.appendChild(s)}
