(function(){
  ...
  function loadContentPolish(){if(document.querySelector('script[data-content-polish-layer]'))return;const s=document.createElement('script');s.src='./assets/content-polish.js';s.dataset.contentPolishLayer='true';document.body.appendChild(s)}
  function init(){loadStyle();if(location.hash.startsWith('#case=')){const id=decodeURIComponent(location.hash.slice(6));setTimeout(()=>stamp(id),80)}loadContentPolish()}
