(function(){
  ...
  function loadElectricalMotion(){const existing=document.querySelector('script[data-electrical-motion-layer]');if(existing){promoteImpeccableLayer();return}const s=document.createElement('script');s.src='./assets/electrical-motion.js';s.dataset.electricalMotionLayer='true';s.onload=promoteImpeccableLayer;document.body.appendChild(s)}
